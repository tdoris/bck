...
class BCKMLPBpropTrain extends BCKDialog {
   ...
   public BCKMLPBpropTrain(BCKMLPBpropDrawable var1) {
      ...
      this.OK.addActionListener(new BCKMLPBpropTrain$1(this));
      JButton var12 = new JButton("Cancel");
      var11.add(this.OK);
      var11.add(var12);
      var12.addActionListener(new BCKMLPBpropTrain$2(this));
      var2.add(var3);
      var2.add(var4);
      var2.add(var5);
      var2.add(var6);
   ...
   public JPanel createTrainFilePanel() {
      ...
      var3.addActionListener(new BCKMLPBpropTrain$3(this));
      var1.add(var2);
   ...
   public JPanel createTestFilePanel() {
      ...
      JButton var3 = new JButton("Browse");
      var3.addActionListener(new BCKMLPBpropTrain$4(this));
      var1.add(var2);
   ...
   public JPanel createParametersPanel() {
      ...
      this.learningRate = new bckRealNumberBox();
      var1.add(this.learningRate);
      var1.add(new JLabel("Momentum :"));
      this.momentum = new bckRealNumberBox();
      var1.add(this.momentum);
      this.learningRate.setText(".5");
      this.momentum.setText("1.1");
      return var1;
   }
   ...
   public JPanel createTrainForEpochs() {
      ...
      var4.addActionListener(new BCKMLPBpropTrain$5(this));
      var1.add(var2);
   ...
   public JPanel createUntilError() {
      ...
      JButton var4 = new JButton("Train");
      var2.add(var4);
      var4.addActionListener(new BCKMLPBpropTrain$6(this));
   ...
   public JPanel createRestart() {
      ...
      var1.add(var2);
      var2.addActionListener(new BCKMLPBpropTrain$7(this));
   ...
   public JPanel createTestPanel() {
      ...
      var1.add(var2);
      var2.addActionListener(new BCKMLPBpropTrain$8(this));
   ...
   public JPanel createGraph() {
      ...
      var2.add(var4);
      var1.add(var2);
      var3.addActionListener(new BCKMLPBpropTrain$9(this));
      var4.addActionListener(new BCKMLPBpropTrain$10(this));
   ...
   public void trainForEpochsPressed() {
      ...
      } else if (Double.isNaN(this.momentum.getRealNumber())) {
         JOptionPane.showMessageDialog(bckframe.top, "Illegal value for Momentum", "Alert", 0);
      } else if (Double.isNaN(this.learningRate.getRealNumber())) {
         JOptionPane.showMessageDialog(bckframe.top, "Illegal value for Learning Rate", "Alert", 0);
      } else {
         this.Net.setMomentum(this.momentum.getRealNumber());
         this.Net.setLearningRate(this.learningRate.getRealNumber());
