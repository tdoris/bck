...
public class BCKMLPQpropDrawable extends BCKQprop implements Drawable, MouseListener, ActionListener, Serializable {
   ...
   public BCKMLPQpropDrawable(int[] var1) {
      super(var1);
      this.setImage();
   }
   ...
   private void setImage() {
      this.image = new BCKImageControl(this.getName(), BCKImageControl.loadImageIcon(bckframe.home + "images/MLPQPROP.jpg", "hello"));
      ...
      this.train = new BCKMLPQpropTrain(this);
   ...
   public void setSelected(boolean var1) {
      ...
      if (var1) {
         this.image.setImage(bckframe.home + "images/MLPQPROPSELECTED.jpg");
      } else {
         this.image.setImage(bckframe.home + "images/MLPQPROP.jpg");
      }
   }
   ...
   public void actionPerformed(ActionEvent var1) {
      ...
      if (var1.getSource() == this.train.OK) {
         try {
            this.setTrainingFile(this.train.trainfilename.getText());
            this.train(10);
