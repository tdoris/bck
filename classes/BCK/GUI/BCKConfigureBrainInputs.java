...
public class BCKConfigureBrainInputs extends BCKDialog {
   ...
   public BCKConfigureBrainInputs(BCKNeuralNetwork var1) {
   ...
   public void makePane() {
      ...
      var4.addActionListener(new BCKConfigureBrainInputs$1(this));
      var3.add(var4);
      JButton var5 = new JButton("Done");
      var5.addActionListener(new BCKConfigureBrainInputs$2(this));
      var3.add(var5);
      var1.add(var3);
   ...
   public JPanel createNetIdsPanel() {
      ...
      var2.add(var3);
      var3.addActionListener(new BCKConfigureBrainInputs$3(this));
      var1.add(var2);
      return var1;
   }
