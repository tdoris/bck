...
public class BCKConnectNetworks extends BCKDialog {
   ...
   public BCKConnectNetworks(BCKNeuralNetwork var1) {
   ...
   public void makePane() {
      ...
      var4.addActionListener(new BCKConnectNetworks$1(this));
      var3.add(var4);
      JButton var5 = new JButton("Done");
      var5.addActionListener(new BCKConnectNetworks$2(this));
      var3.add(var5);
      var1.add(var3);
   ...
   public JPanel createNetIdsPanel() {
      ...
      var2.add(var3);
      var3.addActionListener(new BCKConnectNetworks$3(this));
      JButton var4 = new JButton("Connect All");
      var4.addActionListener(new BCKConnectNetworks$4(this));
      var1.add(var2);
      var1.add(var4);
      return var1;
   }
   ...
   public void connectAll() {
      ...
      for (int var11 = 0; var11 < var10; var11++) {
         ...
         try {
            ...
            JOptionPane.showMessageDialog(null, "Illegal value at row " + var11 + " column 1 " + var15.toString(), "Alert", 0);
            return;
         }
         ...
         int var9 = var3;
         if (var11 >= 0) {
            bckframe.top.theBrain.setProxyInput(this.sourceNet, var5, this.targetNet, var11, var7, var9);
         }
      }
